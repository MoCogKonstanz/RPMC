...
//set to 96mhz speed optimized, needs Serial and Keyboard
...
if (P0.fallingEdge() && P1.fallingEdge() == false && P2.fallingEdge() == false && P3.fallingEdge() == false && P4.fallingEdge() == false){
  ...
  Serial2.write(17); //a binary 20 btw
  //delay(8);
  startShow(0);
  }


else if (P0.fallingEdge() && P1.fallingEdge() && P3.fallingEdge() && P4.fallingEdge() && P2.fallingEdge() == false){
  Serial2.write(27);
  //delay(8);
  startShow(0);
  }  
else if (P1.fallingEdge() && P2.fallingEdge() && P3.fallingEdge() && P4.fallingEdge() && P0.fallingEdge() == false){
  Serial2.write(30);
  //delay(8);
  startShow(0);
  }
else if (P0.fallingEdge() && P1.fallingEdge() && P2.fallingEdge() && P3.fallingEdge() && P4.fallingEdge()){
  Serial2.write(31);
  //delay(8);
  startShow(0);
  }
...
/*deprecated .-> green / yellow + brightness adjustmenst
//NeoPixel Lights
...
void startShow(int i) {
  ...
  switch (i) {
    case 0: strip.setPixelColor(0, 0, 0, 0);    // Black/off
      ...
      strip.show();
      break;
    case 1: strip.setPixelColor(0, 3, 3, 153); //blue
      strip.setPixelColor(1, 76, 3, 153); // magenta
      strip.show();
      break;
    case 2: strip.setPixelColor(0, 3, 3, 153); //blue
      strip.setPixelColor(1, 76, 3, 153); // magenta
      strip.show();
      break;
    case 3: strip.setPixelColor(0, 76, 3, 153); // magenta
      strip.setPixelColor(1, 3, 3, 153); //blue
      strip.show();
      break;
    case 4: strip.setPixelColor(0, 76, 3, 153); // magenta
      strip.setPixelColor(1, 3, 3, 153); //blue
      strip.show();
      break;
    case 5: strip.setPixelColor(0, 76, 3, 153); // magenta
      strip.setPixelColor(1, 3, 3, 153); //blue
      strip.show();
      break;
    case 6: strip.setPixelColor(0, 76, 3, 153); // magenta
      strip.setPixelColor(1, 3, 3, 153); //blue
      strip.show();
      break;
    case 7: strip.setPixelColor(0, 3, 3, 153); //blue
      strip.setPixelColor(1, 76, 3, 153); // magenta
      strip.show();
      break;
    case 8: strip.setPixelColor(0, 3, 3, 153); //blue
      strip.setPixelColor(1, 76, 3, 153); // magenta
      strip.show();
      break;
    case 9: strip.setPixelColor(0, 4, 147, 2); // green
      strip.setPixelColor(1, 93, 160, 5);  // yellow
      strip.show();
      break;
    case 10: strip.setPixelColor(0, 4, 147, 2); // green
      strip.setPixelColor(1, 93, 160, 5);  // yellow
      strip.show();
      break;
    case 11: strip.setPixelColor(0, 93, 160, 5);  // yellow
      strip.setPixelColor(1, 4, 147, 2); // green
      strip.show();
      break;
    case 12: strip.setPixelColor(0, 93, 160, 5);  // yellow
      strip.setPixelColor(1, 4, 147, 2); // green
      strip.show();
      break;
    case 13: strip.setPixelColor(0, 93, 160, 5);  // yellow
      strip.setPixelColor(1, 4, 147, 2); // green
      strip.show();
      break;
    case 14: strip.setPixelColor(0, 93, 160, 5);  // yellow
      strip.setPixelColor(1, 4, 147, 2); // green
      strip.show();
      break;
    case 15: strip.setPixelColor(0, 4, 147, 2); // green
      strip.setPixelColor(1, 93, 160, 5);  // yellow
      strip.show();
      break;
    case 16: strip.setPixelColor(0, 4, 147, 2); // green
      strip.setPixelColor(1, 93, 160, 5);  // yellow
      strip.show();
      break;
     case 17: strip.setPixelColor(1, 0, 0, 0);    // Black/off
